...
const Home = () => {
    ...
    useEffect(() => {
      const fetchProducts = async () => {
        try {
          ...
          setProducts(data.slice(0, 12)); // Take only the first 12 products
        } catch (error) {
  ...
  const buttonStyle = {
    width: "100%",  // Increased width to 130% for longer buttons
    padding: "10px", // Increased padding for a more spacious button
    textAlign: "center",
    fontSize: "14px",
    border: "none",
    borderRadius: "20px", // Added border-radius of 20px
    cursor: "pointer",
    transition: "background-color 0.3s", // Smooth transition for background-color change
    marginBottom: "5px", // Consistent space between buttons
  };
    ...
    useEffect(() => {
      const fetchSlides = async () => {
        try {
          const res = await fetch('http://localhost:8000/api/slides'); // Laravel endpoint
          const data = await res.json();
          setSlides(data.filter(slide => slide.enabled));
        } catch (error) {
  ...
  <Carousel interval={2500} ride="carousel" className="carousel-container"> {/* Set interval for auto-slide */}
    {slides.map((slide, index) => (
      <Carousel.Item key={slide.id}>
        <div className="container">
          <div className="row align-items-center "> {/* This will vertically center the content */}
            <div className="col-md-7 col-lg-6">
              <div className="detail-box" id="koko">
                <h1>
                  <span>{slide.title}</span><br />
                </h1>
                <p>{slide.description}</p>
                <div className="btn-box">
                  <a href="/product" className="btn1">Shop Now</a>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-4">
              <div className="box ">
                ...
                <div className="detail-box">
                  ...
                  <p>
                  Shop now, fast delivery to your doorstep!
                  </p>
                </div>
              </div>
            </div>
            <div className="col-md-4">
              <div className="box ">
                ...
                <div className="detail-box">
                  ...
                  <p>
                  Shop now and enjoy free shipping today!
                  </p>
                </div>
              </div>
            </div>
            <div className="col-md-4">
              <div className="box ">
                ...
                <div className="detail-box">
                  ...
                  <p>
                  Shop now for the best quality clothes!
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="box">
                  <div className="option_container">
                    <div className="options">
                      <a className="option1" onClick={() => addToCart(product)}>
                        Add To Cart
                      </a>
                     {/* Buy Now Button with Black color */}
                     <button
                              className="option2"
                              style={{
                                ...buttonStyle,
                              ...
                              onClick={() => {
                                ...
                                const total = product.price; // Single product total
                                navigate("/payment", { state: { carts: cart, total } });
                              }}
                            >
                              Buy Now
                            </button>
              ...
              <div className="carousel-item">
                <div className="box col-lg-10 mx-auto">
                  ...
                  <div className="detail-box">
                    ...
                    <p>
                    I’m thrilled with my purchase! The clothes are stylish, high-quality, and fit perfectly. Fast delivery and excellent customer service. This shop is my new favorite for trendy, must-have pieces!
                    </p>
                  </div>
                </div>
              </div>
